...
const SECURITY_KEYWORDS: Record<SecurityCategory, KeywordEntry[]> = {
  ...
  political_crisis: [
    ...
    { words: ['kejaksaan agung', 'kejagung', 'jampidsus', 'jaksa agung', 'kejaksaan'], weight: 8, tags: ['hukum', 'kejaksaan'] },
    { words: ['polri', 'kapolri', 'polisi', 'kepolisian', 'brimob', 'bareskrim'], weight: 7, tags: ['hukum', 'kepolisian'] },
    { words: ['penangkapan', 'ditangkap', 'diringkus', 'diamankan', 'dicokok'], weight: 7, tags: ['hukum', 'penangkapan'] },
    { words: ['konflik institusi', 'ketegangan', 'sengketa', 'pertikaian', 'perseteruan'], weight: 8, tags: ['konflik-institusi'] },
    { words: ['oknum', 'jaksa nakal', 'polisi nakal', 'aparat', 'penegak hukum'], weight: 6, tags: ['aparat', 'hukum'] },
    { words: ['kpk', 'komisi pemberantasan korupsi', 'pimpinan kpk', 'penyidik kpk'], weight: 8, tags: ['kpk', 'korupsi'] },
    { words: ['tahanan', 'ditahan', 'dipenjara', 'sel tahanan', 'rutan', 'lapas'], weight: 6, tags: ['hukum', 'pemasyarakatan'] },
    { words: ['pengadilan', 'sidang', 'vonis', 'dihukum', 'putusan hakim'], weight: 6, tags: ['hukum', 'pengadilan'] },
    { words: ['korupsi', 'tipikor', 'tindak pidana korupsi', 'gratifikasi', 'suap'], weight: 8, tags: ['korupsi'] },
  ],
  disaster_emergency: [
  ...
  regulatory_legal: [
    ...
    { words: ['kejaksaan agung', 'kejagung', 'jampidsus', 'jaksa agung', 'kejaksaan'], weight: 8, tags: ['hukum', 'kejaksaan'] },
    { words: ['polri', 'kapolri', 'polisi', 'kepolisian', 'bareskrim'], weight: 7, tags: ['hukum', 'kepolisian'] },
    { words: ['penangkapan', 'ditangkap', 'diringkus', 'diamankan', 'dicokok'], weight: 7, tags: ['hukum', 'penangkapan'] },
    { words: ['konflik institusi', 'ketegangan', 'sengketa', 'pertikaian', 'perseteruan'], weight: 8, tags: ['konflik-institusi'] },
    { words: ['oknum', 'jaksa nakal', 'polisi nakal', 'aparat', 'penegak hukum'], weight: 6, tags: ['aparat', 'hukum'] },
    { words: ['kpk', 'komisi pemberantasan korupsi', 'pimpinan kpk', 'penyidik kpk'], weight: 8, tags: ['kpk', 'korupsi'] },
